...
//       Defining and initializing our variables
...
// Now displaying/printing the variables, as a consequence of the code run
        ...
        // end
        // For those who gonna review this code pls one of you make any comment on it, me to be able to practice also commit amend action.
        // I will update the comments let's say.
        // Adding one more comment as an improvement requested by one of my colleagues , then to apply commit amend command
    }
